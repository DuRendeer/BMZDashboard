    ...
    <style>
        * {
        ...
        .main-content {
            ...
            align-items: center;
            opacity: 0;
            animation: contentFadeIn 1s ease-in 1s forwards;
        }
        ...
        .title {
            ...
            margin-bottom: 3rem;
            text-align: center;
            background: linear-gradient(45deg, #00f5ff, #ff6b6b, #4ecdc4, #45b7d1, #96ceb4);
        ...
        .title::before {
            ...
            width: 100%;
            height: 100%;
            background: linear-gradient(45deg, #ff6b6b, #4ecdc4, #45b7d1, #96ceb4, #00f5ff);
            background-size: 300% 300%;
            -webkit-background-clip: text;
            background-clip: text;
            color: transparent;
            animation: titleGradient 3s ease-in-out infinite reverse;
            z-index: -1;
            filter: blur(1px);
        }
        ...
        .brutalist-button.api-music {
            background-color: #e74c3c;
        }

        .brutalist-button.mapping {
            background-color: #f39c12;
        }

        .brutalist-button.sync {
            background-color: #3498db;
        }

        .brutalist-button.tips {
            background-color: #5dade2;
        }

        .brutalist-button.dashboard {
            background-color: #9b59b6;
        }

        .brutalist-button.form-anonimo {
            background-color: #27ae60;
        }

        .brutalist-button.emails {
            background-color: #e67e22;
        }

        .brutalist-button.roleta {
            background-color: #8e44ad;
        }

        .brutalist-button.calc-aux {
        ...
        .brutalist-button.api-music::before {
            background-color: #c0392b;
        }

        .brutalist-button.mapping::before {
            background-color: #d68910;
        }

        .brutalist-button.sync::before {
            background-color: #2980b9;
        }

        .brutalist-button.tips::before {
            background-color: #4a90b8;
        }

        .brutalist-button.dashboard::before {
            background-color: #8e44ad;
        }

        .brutalist-button.form-anonimo::before {
            background-color: #229954;
        }

        .brutalist-button.emails::before {
            background-color: #d35400;
        }

        .brutalist-button.roleta::before {
            background-color: #7d3c98;
        }

        .brutalist-button.calc-aux::before {
        ...
        .brutalist-button:hover .button-logo {
        ...
        .wheel-and-hamster {
            ...
            z-index: 200;
            opacity: 1;
            animation: hamsterIntro 1s ease-out forwards;
        }

        @keyframes hamsterIntro {
            0% {
                opacity: 1;
...
<body>
    ...
    <div class="main-content">
        <h1 class="title" data-text="BMZ Menu Utilidades">BMZ Menu Utilidades</h1>
